...
function handle_dispatch(payload){
  switch(payload.t){
    case 'GUILD_CREATE': 
      console.log(payload.d.members[0]); 
      console.log(payload.d.members[1]); 
      console.log(payload.d.members[2]); 
      break;

    default:
      console.log('unrecognized dispatch');
  }
